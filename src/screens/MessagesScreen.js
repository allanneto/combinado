...
import {listNotificaMsg} from '~/services/notificaApi';
...
class MessagesScreen extends Component {
  ...
  viewNotification = item => {
    if (item.msgId) {
      ...
      // Notificar o remetente que voltei para o chat
      // const uId = item.rem;
      // notify(
      //   uId,
      //   tit,
        ...
        <View style={{flex: 1}}>
          {this.state.data && this.state.data.length > 0 ? (
            <FlatList
              ...
              keyExtractor={(item, i) => item.tms + i}
