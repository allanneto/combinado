...
class EventNome extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      item: null,
  ...
  saveValue = () => {
    if (!this.state.item) {
      this.setState({error: 'Nome é obrigatório'});
      return;
    }
    Keyboard.dismiss();
    ...
    updateEvent(event)
      .then(() => {
        ...
        this.state.onChange('tit', this.state.item);
      ...
      return (
        <View style={styles.container}>
          <View style={styles.headerContainer}>
            <Text>Nome ou título do evento</Text>
          </View>
...
export default connect(mapStateToProps)(EventNome);
